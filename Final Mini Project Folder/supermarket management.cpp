...
class EmployeeLog
{
    string employee_id, employee_pass, login_id, login_pass;
...
public:
    ...
    {
        line();
        cout<<endl<<setw(60)<<"EMPLOYEE LOGIN\n\n";
        line();
...
label:
        ...
        cout<<"PASSWORD = ";
        cin>>login_pass;
        if(login_id.compare(employee_id)==0)
        {
            if(login_pass.compare(employee_pass)==0)
            {
                return 1;
            }
